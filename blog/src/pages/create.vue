  ...
  <div>
    ...
    <section class="main">
      <div class="edit">
        ...
        <h3>文章内容</h3>
        <el-input type="textarea" v-model="content" :autosize="{ minRows: 6, maxRows: 30 }"></el-input>
        <p>
          <label>是否展示到主页</label>
...
export default {
  ...
  methods: {
    onCreate () {
      request.createBlog({ title: this.title, content: this.content, description: this.description, atIndex: this.atIndex }).then(res => {
